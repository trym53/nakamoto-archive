...
**Message #6**  
**Date**: Tue, 04 Nov 2008 06:20:13 +1000  
...
Satoshi Nakamoto wrote: > Long before the network gets anywhere near as large as > that, it would be Safe for users to use Simplified > Payment Verification (section 8) to check for double > spending, which only requires having the chain of > block headers,
